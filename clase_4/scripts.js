...
p1.addProduct("producto prueba", "Este es un producto prueba", 200, "Sin imagen", "abc123", 25);
p1.addProduct("producto prueba2", "Este es un producto prueba", 200, "Sin imagen", "abc1234", 25);

p1.getProducts().then(res => console.log(res)).catch(error => console.log(error))
p1.getProductById(1)
